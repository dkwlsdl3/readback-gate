...
export const fixtures: PromptFixture[] = [
  ...
  { name: 'ko nonexec question structure', prompt: '이 프로젝트 구조 어떻게 되어 있어?', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'en nonexec question modes', prompt: 'What is the difference between inject and strict mode?', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'ko nonexec question strict', prompt: '왜 strict 모드가 기본이 아니야?', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'en nonexec question deterministic', prompt: 'Why is the scorer deterministic?', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'ko nonexec status progress', prompt: '진행 상황 어디까지 됐어?', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'en nonexec status test results', prompt: 'Summarize the test results.', min: 70, max: 100, verdict: 'pass', risk: 'low' },
  { name: 'ko nonexec status commit log', prompt: '방금 커밋 로그 보여줘', min: 70, max: 100, verdict: 'pass', risk: 'medium' },
  { name: 'en nonexec status git', prompt: 'Show me the current git status.', min: 70, max: 100, verdict: 'pass', risk: 'low' },
  { name: 'ko nonexec ack plan', prompt: '오 좋다 그럼 그렇게 가자', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'ko nonexec ack okay plan', prompt: '오케이 그렇게 하자', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'en nonexec ack thanks', prompt: 'Great, thanks!', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'ko nonexec ack thanks', prompt: 'ㅇㅋ 고마워요', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'en nonexec ack makes sense', prompt: 'Yeah that makes sense.', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'ko disguised restart status', prompt: '서버 상태 재시작해줘', min: 0, max: 69, verdict: 'inject', risk: 'medium' },
  { name: 'ko disguised reset status', prompt: 'main 브랜치 상태 리셋해줘', min: 0, max: 69, verdict: 'inject', risk: 'medium' },
  { name: 'ko disguised wipe result', prompt: '이거 다 지우고 결과 보여줘', min: 0, max: 69, verdict: 'inject', risk: 'medium' },
  { name: 'ko disguised commit status', prompt: '커밋하고 상태 알려줘', min: 0, max: 69, verdict: 'inject', risk: 'medium' },
  { name: 'ko disguised push status', prompt: '푸시 상태 보여줘', min: 0, max: 69, verdict: 'inject', risk: 'medium' },
  { name: 'en disguised restart status', prompt: 'restart the service and show status', min: 0, max: 69, verdict: 'inject', risk: 'medium' },
  { name: 'ko disguised overwrite status', prompt: '환경변수 상태 덮어써줘', min: 0, max: 69, verdict: 'inject', risk: 'low' },
  { name: 'ko disguised merge question', prompt: '브랜치 어떻게 되어 있는지 보고 머지해줘', min: 0, max: 69, verdict: 'inject', risk: 'none' },
  { name: 'en disguised revert diff', prompt: 'show me the diff then revert it', min: 0, max: 69, verdict: 'inject', risk: 'low' },
  { name: 'ko disguised rollback log', prompt: '로그 확인하고 롤백해줘', min: 0, max: 69, verdict: 'inject', risk: 'none' },
  { name: 'en nonexec build green', prompt: 'is the build green now?', min: 70, max: 100, verdict: 'pass', risk: 'none' },
  { name: 'ko safety delete after status', prompt: '상태 보여주고 삭제해줘', min: 0, max: 69, verdict: 'gate', risk: 'high' },
  { name: 'ko safety deploy after status', prompt: '상태 보여주고 운영에 배포해줘', min: 0, max: 69, verdict: 'gate', risk: 'high' },
  { name: 'ko safety drop after list', prompt: '목록 보여주고 drop 해줘', min: 0, max: 69, verdict: 'gate', risk: 'high' },
  { name: 'ko safety force push after status', prompt: '상태 확인하고 force push 해줘', min: 0, max: 69, verdict: 'gate', risk: 'high' },
  { name: 'ko safety publish after status', prompt: '현재 상태 알려주고 prod에 publish 해줘', min: 0, max: 69, verdict: 'gate', risk: 'high' },
  { name: 'ko safety merge after status', prompt: '상태 보여주고 머지해줘', min: 0, max: 69, verdict: 'inject', risk: 'low' },
  { name: 'ko risky question force push', prompt: 'main에 강제 푸시할까?', min: 0, max: 69, verdict: 'gate', risk: 'high' },
  { name: 'en risky question drop database', prompt: 'Should I drop the production database?', min: 0, max: 69, verdict: 'gate', risk: 'high' }
];
